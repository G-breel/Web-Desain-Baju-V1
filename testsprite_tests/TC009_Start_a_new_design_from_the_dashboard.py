...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Masuk' (login) link to navigate to the login page.
        # link "Masuk"
        elem = page.locator("xpath=/html/body/div[2]/header/nav/div/a").nth(0)
        await elem.wait_for(state="visible", timeout=10000)
        await elem.click()
        
        # -> Fill the email field with admin@gmail.com (input into element [236]).
        ...
        # -> Click the '+ Desain Baru' button (element [38138]) to start a new design and then verify the product selection page appears with available product types.
        # link "Desain Baru"
