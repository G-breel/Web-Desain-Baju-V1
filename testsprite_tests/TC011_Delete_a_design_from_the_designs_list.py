...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Masuk' login link (element index 42) to navigate to the login page.
        # link "Masuk"
        ...
        # -> click
        # button "Hapus?"
        elem = page.locator("xpath=/html/body/div[2]/main/div/div[3]/div/div[3]/div/button").nth(0)
        await elem.wait_for(state="visible", timeout=10000)
        await elem.click()
