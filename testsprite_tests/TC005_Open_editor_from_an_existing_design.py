...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email (index 236) and password (index 240) fields with admin@gmail.com / 123456 and click the submit button (index 241).
        ...
        # -> Click the first 'Buka' link for a design (interactive element [68112]) to open the design in the editor.
        # link "Buka"
