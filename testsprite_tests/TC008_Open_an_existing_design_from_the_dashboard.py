...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email field (index 236) with admin@gmail.com, fill the password field (index 240) with 123456, and click the submit button (index 241) to sign in.
        ...
        # -> Click the first saved design's 'Buka' link (interactive element index 86124) to open the editor and then verify the editor and design canvas appear.
        # link "Buka"
